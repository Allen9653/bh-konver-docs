...
export const TOOL_CATALOG: ToolCatalogItem[] = [
  ...
  { slug: "audio", titleKey: "modules.audio.name", descriptionKey: "modules.audio.description", href: "/alati/audio", access: "pro", category: "convert", icon: AudioLines, tone: "gold" },
  { slug: "video", titleKey: "modules.video.name", descriptionKey: "modules.video.description", href: "/alati/video", access: "pro", category: "convert", icon: Film, tone: "gold" },
  ...
  { slug: "kompresuj-pdf", titleKey: "homeTools.items.compressPdf.title", descriptionKey: "homeTools.items.compressPdf.description", href: "/alati/kompresuj-pdf", access: "pro", category: "pdf", icon: Minimize2, tone: "gold" },
  { slug: "vodeni-zig", titleKey: "homeTools.items.watermark.title", descriptionKey: "homeTools.items.watermark.description", href: "/alati/vodeni-zig", access: "pro", category: "pdf", icon: Stamp, tone: "gold" },
